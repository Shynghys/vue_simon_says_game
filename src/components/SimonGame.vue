...
export default {
  ...
  data() {
    return {
      ...
      audiosArray: [audio_0, audio_1, audio_2, audio_3],
  ...
  computed: {
    languagesLocales() {
      ...
      switch (
        languageButtons.value //try [languageButtons.value]: language
      ) {
        case "ru":
          return {
            round: "Раунд",
  ...
  methods: {
    ...
    startTheGame() {
      ...
      this.setGameSelectedSectorsArray();
    ...
    setGameSelectedSectorsArray() {
      this.gameSelectedSectorsArray.push(this.getRandomNumber());
    },
